...
dis_X1=density(x_inputs[,"X3"])
hist(x_inputs[,"X3"],freq = FALSE,main = "Histogram and density plot of X3",xlab = "X3 Signal") 
lines(dis_X1,lwd=2,col="red")
# Add the data-poins with noise in the X-axis
rug(jitter(x_inputs[,"X3"]))
```

```{r}
#Creating a density if X5 signal
dis_X1=density(x_inputs[,"X4"])
hist(x_inputs[,"X4"],freq = FALSE,main = "Histogram and density plot of X4",xlab = "X4 Signal") 
lines(dis_X1,lwd=2,col="red")
# Add the data-poins with noise in the X-axis
rug(jitter(x_inputs[,"X4"]))
```

```{r}
#Creating a density if X5 signal
dis_X1=density(y_output[,"Y"])
hist(y_output[,"Y"],freq = FALSE,main = "Histogram and density plot of Y",xlab = "Y Signal") 
lines(dis_X1,lwd=2,col="red")
# Add the data-poins with noise in the X-axis
rug(jitter(y_output[,"Y"]))
```
```{r}
plot(density(y_output), col="blue", lwd=2, main="Distribution of Y output", 
     xlab="Value", ylab="Density")
```

```{r}
# Plotting X1 against Y
plot(x_inputs[,"X1"],y_output,main = "Correlation betweeen X1 and Y signal", xlab = "X1 signal", ylab = "Output signal" )
# Plotting X2 against Y
plot(x_inputs[,"X2"],y_output,main = "Correlation betweeen X2 and Y signal", xlab = "X2 signal", ylab = "Output signal")
# Plotting X3 against Y
plot(x_inputs[,"X3"],y_output,main = "Correlation betweeen X3 and Y signal", xlab = "X3 signal", ylab = "Output signal")
# Plotting X4 against Y
plot(x_inputs[,"X4"],y_output,main = "Correlation betweeen X4 and Y signal", xlab = "X4 signal", ylab = "Output signal")
```
